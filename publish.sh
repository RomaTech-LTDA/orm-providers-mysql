...
# ---------------------------------------------------------------------------
# publish.sh — Build verification and npm publish for @romatech/orm-providers-mysql
# ---------------------------------------------------------------------------
# Usage:
...
echo "============================================"
echo " @romatech/orm-providers-mysql — publish pipeline"
echo "============================================"
echo ""
...
# 7. Publish
echo "[6/6] Publishing @romatech/orm-providers-mysql@$NEW_VERSION to npm..."
npm publish --access public
echo ""

echo "============================================"
echo " Published @romatech/orm-providers-mysql@$NEW_VERSION"
echo "============================================"
